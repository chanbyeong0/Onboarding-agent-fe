...
export function updateLearningProgress(sessionId: string, payload: ProgressUpdateRequest): Promise<SessionProgress> {
  return apiRequest<SessionProgress>(`/api/v1/lecture-sessions/${sessionId}/progress`, {
    method: 'PATCH',
    body: payload,
  })
}
